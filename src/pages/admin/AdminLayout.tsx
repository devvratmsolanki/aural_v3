...
import { Music2, Tag, Users, BarChart3, LayoutDashboard, ArrowLeft } from "lucide-react";
...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-dvh flex bg-background text-foreground">
      <aside className="w-60 bg-card border-r border-border p-6 flex flex-col gap-2 shrink-0">
        <NavLink to="/" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground mb-6">
