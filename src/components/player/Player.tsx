...
export const Player = () => {
  ...
  return (
    <footer className="h-24 md:h-24 bg-card border-t border-border flex items-center justify-between px-3 md:px-6 shrink-0 z-10 shadow-deck">
      <div className="flex items-center gap-2 md:gap-4 w-[35%] md:w-1/4 min-w-0">
        {current ? (
          <>
            ...
            <button onClick={toggleLike} className="ml-2 text-muted-foreground hover:text-primary transition-colors" aria-label={liked ? "Unlike" : "Like"}>
      ...
      <div className="flex items-center justify-end gap-2 md:gap-3 md:w-1/4">
        {current && (
          <Sheet open={extrasOpen} onOpenChange={setExtrasOpen}>
            ...
            <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
              ...
              <Tabs value={extrasTab} onValueChange={(v) => setExtrasTab(v as any)} className="mt-4">
        ...
        {current && (
          <button onClick={() => { setExtrasTab("notes"); setExtrasOpen(true); }} className="text-muted-foreground hover:text-primary transition-colors p-1.5" aria-label="Notes">
      ...
      {current && (
        <Sheet open={fullOpen} onOpenChange={setFullOpen}>
          <SheetContent side="bottom" className="h-[100dvh] p-0 border-0 bg-gradient-velvet">
            <div className="h-full flex flex-col items-center justify-between px-6 py-10 max-w-md mx-auto">
              ...
              <div className="flex items-center gap-6">
                ...
                <button onClick={() => { setFullOpen(false); setExtrasTab("notes"); setExtrasOpen(true); }} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary"><StickyNote className="h-4 w-4" /> Notes</button>
